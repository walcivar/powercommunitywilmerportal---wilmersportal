...
window.onload = ()=>{
    var arr=[  
"https://nfernandezba.sharepoint.com/sites/SharePointPowerAppBootcampSite/_api/web/lists/getbytitle('Images')/items(1)/File/$value",   
"https://nfernandezba.sharepoint.com/sites/SharePointPowerAppBootcampSite/_api/web/lists/getbytitle('Images')/items(2)/File/$value",  
"https://nfernandezba.sharepoint.com/sites/SharePointPowerAppBootcampSite/_api/web/lists/getbytitle('Images')/items(3)/File/$value"];
 var rootUrl= "https://nfernandezba.sharepoint.com";
